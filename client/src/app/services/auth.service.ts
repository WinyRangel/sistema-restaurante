...
export class AuthService {
  ...
  private rol: string = '';
  private url = 'http://3.145.150.131:3002/api/users';
  private urlRegistro = 'http://3.145.150.131:3002/api/users/registro';
  private urlLogin = 'http://3.145.150.131:3002/api/users/login';
